...
public class ContinuationPassingIdentityPipeline {
    ...
    public ContinuationPassingIdentityPipeline(MalformedIdentityRepository malformed, IdentityReader identityReader,
    ...
    private void format(Identity identity, BiConsumer<Identity, Throwable> failed,
            Consumer<Identity> identityFormatted) {
        verifyPool.submit(() -> {
    ...
    private void persist(Identity identity, BiConsumer<Identity, Throwable> failed,
            Consumer<Identity> identityPersisted) {
        persistPool.submit(() -> {
