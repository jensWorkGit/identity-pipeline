    ...
    public Identity read(InputStream is) {
        try {
            ...
            if (line != null) {
                ...
                Person p = new Person(parts[0], parts[1].toCharArray(), parts[2], parts[3], parts[4],
                        Arrays.asList(new Address(parts[5], parts[6], parts[7], parts[8])), Integer.parseInt(parts[9]));
                return p;
            } else {
                return null;
            }
